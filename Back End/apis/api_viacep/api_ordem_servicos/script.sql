...
INSERT INTO USUARIOS(nome, email, senha) VALUES('Leticia Jesus', 'leticia.jesus@email.com','senha321');

INSERT INTO DEPARTAMENTOS(nome,descricao) VALUES('TI','tecnologia da informação'),
('Manutenção','Setor Manutenção geral');

INSERT INTO ORDEM_SERVICOS(numero_ordem, titulo, descricao, prioridade, status, data, id_usuario, id_departamento) VALUES
 (1001,'Trocar cabo de rede','Ponto de rede da sala 203 esta sem conexão', 'média','aberta','2026-02-26',3,3 ),
 (1002,'Consertar ar-condicionado','Unidade do laboratório parou de gelar', 'alta','em-andamento', '2026-02-26',4,4);